...
from agent.aether_orchestrator.memory_parser import AetherNavigator, yaml
import os
...
class TestMemoryParser(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_vector_search_with_mock_index(self):
        ...
        with patch('agent.aether_orchestrator.memory_parser.faiss') as mock_faiss:
    ...
    def test_init_fallback(self):
        from agent.aether_orchestrator.memory_parser import VectorEncoder
        try:
