...
if TYPE_CHECKING:
    from agent.aether_orchestrator.aether_evolve import AetherNeuralMonitor
...
class TelemetryHandler:
    ...
    def get_recent_anomalies(self, limit: int = 10) -> list:
        ...
        """
        if limit <= 0 or not self.monitor.anomaly_log:
            return []
        return self.monitor.anomaly_log[-limit:]
