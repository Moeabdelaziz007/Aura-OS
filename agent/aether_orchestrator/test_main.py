...
from agent.aether_orchestrator.main import AetherCoreOrchestrator, SynapticMessage, ActionContext
...
class TestAetherCoreOrchestrator(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        # Mock dependencies
        self.mock_gemini_cls = patch('agent.aether_orchestrator.main.GeminiLiveClient').start()
        ...
        self.mock_router_cls = patch('agent.aether_orchestrator.main.HyperMindRouter').start()
        ...
        self.mock_navigator_cls = patch('agent.aether_orchestrator.main.AetherNavigator').start()
        ...
        self.mock_monitor = patch('agent.aether_orchestrator.main.monitor').start()
        self.mock_evolve_engine = patch('agent.aether_orchestrator.main.evolve_engine').start()
